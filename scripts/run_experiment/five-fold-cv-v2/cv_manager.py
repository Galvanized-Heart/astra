...
CV_RUN_CONFIGS_FILE = os.path.join(SCRIPT_DIR, "ablation_cv_configs.json")
LAST_SUBMITTED_INDEX_FILE = os.path.join(SCRIPT_DIR, "last_submitted_index_ablation.txt")
