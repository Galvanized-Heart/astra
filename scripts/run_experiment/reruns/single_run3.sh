...
uv run src/astra/pipelines/hydra_train.py experiment_mode=multi_task/advanced architecture=linear data=fold_1 model.lightning_module.mtl_strategy=uncertainty wandb.group=Uncertainty-Advanced-Linear extra_tags=[uncertainty_exp,5fcv] trainer.epochs=20 model.lightning_module.lr=0.0014117485201455109 data.batch_size=64 architecture.params.dim_1=512 architecture.params.dim_2=128
