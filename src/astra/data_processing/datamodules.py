...
class AstraDataModule(L.LightningDataModule):
    ...
    def __init__(self, full_path=None, batch_size: int = 32, train_path=None, valid_path=None, test_path=None, predict_path=None):
        """
        ...
        if full_path is None:
            full_path = Path.join(PROJECT_ROOT, "data", "interim", "cpipred", "CPI_all_brenda_core_enriched.csv")
    ...
    def setup(self, stage: str):
        ...
        if stage == "fit":
            ...
            self.train_dataset = ProteinLigandDataset(self.full_path) # TODO: temporary full_path, will become train_path
            print("Training set complete.")

        if stage == "validate" or stage == "fit":
            print("Setting up validation dataset...")
            self.valid_dataset = ProteinLigandDataset(self.full_path) # TODO: temporary full_path, will become valid_path
